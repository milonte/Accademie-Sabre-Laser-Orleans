...
class MemberManager extends AbstractManager
{
    ...
    {
        $statement = $this->pdo->prepare("INSERT INTO $this->table  (lastname, firstname, email, adress,
        postal_code, city, phone, birth_date,emergency_contact, emergency_phone, payment, status) VALUES (:firstname,
        :lastname, :email, :adress, :postal_code,:city, :phone, :birth_date, :emergency_contact, :emergency_phone,
        :payment, 'pending')");
